...
`docs/hypothesis_transition_strategy_reference.md` 记录当前 strategy-chain、prior assignment、discrete state controller
...
engine.modules.hypo_transitions_mod.kwargs:
  values_from_json:
    path: ../../configs/candidates/hypothesis_transition/<file>.json
