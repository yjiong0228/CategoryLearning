...
ksimilar_setting = (PartitionCluster._amount_accuracy_gen(random_acc_amount_f, 3), "ksimilar_centers")
...
joblib.dump(res, result_path / 'M_fgt_cl_rand7_randp_acc3rand_acc7.joblib')
