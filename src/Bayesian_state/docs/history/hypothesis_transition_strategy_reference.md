...
`FixedStrategyHypothesisTransitionModule`; a trial-varying discrete state is executed
by `DynamicDiscreteStrategyHypothesisTransitionModule`.  The underlying strategy-chain
...
hyperparam_space:
  __profile_candidate__:
    values_from_json:
      path: ../../configs/candidates/hypothesis_transition/hypothesis_transition_profile_v11_candidates.json
      key: cond1_v11
