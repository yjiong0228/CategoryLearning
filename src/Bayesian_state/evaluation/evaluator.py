...
Transition-specific diagnostics and Oral/model alignment are implemented in
``transition.py`` and ``oral/alignment.py`` respectively, and
mixed in here so existing ``ModelEvaluator`` call sites keep working.
"""
...
from src.Bayesian_state.evaluation.oral.alignment import OralModelAlignmentMixin
from src.Bayesian_state.evaluation.particle_filter.summary import (
    ParticleFilterEvaluationMixin,
)
from src.Bayesian_state.evaluation.transition import TransitionEvaluationMixin
...
class ModelEvaluator(
    ...
    def _extract_run_eval_curves(run_obj, eval_prediction_mode=None):
        ...
        true_acc = ModelEvaluator._as_float_1d(metrics.get("sliding_true_acc"), "sliding_true_acc")
        pred_acc = ModelEvaluator._as_float_1d(metrics.get("sliding_pred_acc"), "sliding_pred_acc")
        pred_std = ModelEvaluator._as_float_1d(metrics.get("sliding_pred_acc_std"), "sliding_pred_acc_std")
