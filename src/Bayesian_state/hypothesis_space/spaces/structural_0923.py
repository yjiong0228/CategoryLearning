"""Bounded structural probes for Model 0923; no production defaults change."""
...
OVERLAP_PROBE_VERSION = "continuous_axis_pair_overlap_0923_v1"
...
def build_axis_pair_overlap_probe_space() -> ContinuousHypothesisSpace:
    ...
    Labels retain the ordinary axis-equality sign order. This is a geometry
    candidate, not the B1 structural-search mechanism or an adopted B0 space.
    """
