...
DEFAULT_CONFIG = ROOT / "configs/exp123/specific_models/model_0818_boundary_recovery.yaml"
...
def main() -> None:
    ...
    manuscript_path = ROOT / "src/Bayesian_state/docs/model_architecture/model_0818.tex"
    manifest = {
