"""External hyperparameter value sources."""
...
def values_from_json(spec: Mapping[str, Any], config_dir: Path) -> List[Any]:
    """Load a hyperparameter value list from a JSON candidate file."""
...
def validate_no_nested_hyperparam_paths(param_specs: Mapping[str, Any]) -> None:
    """Reject parent/child dotted hyperparameter paths in one search space."""
