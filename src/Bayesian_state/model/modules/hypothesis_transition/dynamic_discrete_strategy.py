...
class DynamicDiscreteStrategyHypothesisTransitionModule(
    TwoStepHypothesisTransitionMixin,
    ...
    def __init__(self, engine, **kwargs):
        ...
        if resolved.get("state_controller") is None:
            raise ValueError(
                "DynamicDiscreteStrategyHypothesisTransitionModule requires a non-empty "
                "state_controller."
            )
...
__all__ = ["DynamicDiscreteStrategyHypothesisTransitionModule"]
