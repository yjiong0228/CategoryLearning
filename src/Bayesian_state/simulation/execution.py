...
from .results import SingleRunResult
...
def compute_prediction_metrics(
    ...
    if engine_beta is None:
        beta_param = float(model.engine.observation_likelihood.default_beta)
...
def _evaluate_state_model_particle_filter_run(
    *,
    ...
    from ..inference.dispatcher import (
    ...
    diagnostic_arrays = {
        ...
        "particle_predictive_peak_mastery_evidence": latent[
        ...
        "particle_predictive_rule_commitment_probability": latent[
            "predictive_rule_commitment_probability"
        ],
        "particle_predictive_rule_commitment_eligible_probability": latent[
            "predictive_rule_commitment_eligible_probability"
        ],
        "particle_predictive_rule_commitment_entry_event_probability": latent[
            "predictive_rule_commitment_entry_event_probability"
        ],
        "particle_predictive_rule_commitment_exit_event_probability": latent[
            "predictive_rule_commitment_exit_event_probability"
        ],
        "particle_predictive_rule_commitment_age": latent[
            "predictive_rule_commitment_age"
        ],
        "particle_predictive_rule_commitment_disconfirmation": latent[
            "predictive_rule_commitment_disconfirmation"
        ],
        "particle_predictive_rule_commitment_margin": latent[
            "predictive_rule_commitment_margin"
        ],
        "particle_predictive_rule_commitment_confidence_signal": latent[
            "predictive_rule_commitment_confidence_signal"
        ],
        "particle_predictive_rule_commitment_choice_precision": latent[
        ...
        "choice_readout_rule_commitment_confidence_gain": (
            rule_commitment_confidence_gain
        ),
    ...
    if keep_logs:
        transition_counts = [
            {
                ...
                "peak_mastery_evidence": float(
                    latent["predictive_peak_mastery_evidence"][index]
                ),
                ...
                "rule_commitment_probability": float(
                    latent["predictive_rule_commitment_probability"][index]
                ),
                "rule_commitment_eligible_probability": float(
                    latent[
                        "predictive_rule_commitment_eligible_probability"
                    ][index]
                ),
                "rule_commitment_entry_event_probability": float(
                    latent[
                        "predictive_rule_commitment_entry_event_probability"
                    ][index]
                ),
                "rule_commitment_exit_event_probability": float(
                    latent[
                        "predictive_rule_commitment_exit_event_probability"
                    ][index]
                ),
                "rule_commitment_age": float(
                    latent["predictive_rule_commitment_age"][index]
                ),
                ...
                "rule_commitment_margin": float(
                    latent["predictive_rule_commitment_margin"][index]
                ),
                "rule_commitment_confidence_signal": float(
                    latent[
                        "predictive_rule_commitment_confidence_signal"
                    ][index]
                ),
                "rule_commitment_choice_precision": float(
                    latent[
                        "predictive_rule_commitment_choice_precision"
                    ][index]
                ),
        ...
        state_log = {
            ...
            "predictive_peak_mastery_evidence": latent[
                "predictive_peak_mastery_evidence"
            ],
            ...
            "predictive_rule_commitment_probability": latent[
                "predictive_rule_commitment_probability"
            ],
            "predictive_rule_commitment_eligible_probability": latent[
                "predictive_rule_commitment_eligible_probability"
            ],
            "predictive_rule_commitment_entry_event_probability": latent[
                "predictive_rule_commitment_entry_event_probability"
            ],
            "predictive_rule_commitment_exit_event_probability": latent[
                "predictive_rule_commitment_exit_event_probability"
            ],
            "predictive_rule_commitment_age": latent[
                "predictive_rule_commitment_age"
            ],
            "predictive_rule_commitment_disconfirmation": latent[
                "predictive_rule_commitment_disconfirmation"
            ],
            "predictive_rule_commitment_margin": latent[
                "predictive_rule_commitment_margin"
            ],
            "predictive_rule_commitment_confidence_signal": latent[
                "predictive_rule_commitment_confidence_signal"
            ],
            "predictive_rule_commitment_choice_precision": latent[
                "predictive_rule_commitment_choice_precision"
            ],
