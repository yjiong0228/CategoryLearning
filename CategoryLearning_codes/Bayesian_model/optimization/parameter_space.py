...
MODEL_0826_SPIKE_PARAMETERS = ("delta_E", "c_A", "c_G")
MODEL_0826_SUBJECT_PARAMETERS = {
    "workspace_execution",
    "gamma",
    "E_C",
    "delta_E",
...
def load_model_parameter_space(
    ...
    """Load a versioned Model 0826 parameter-space YAML file."""
...
def validate_model_parameter_space(
    ...
    *,
    ...
    missing = MODEL_0826_SUBJECT_PARAMETERS - set(parameters)
    extra = set(parameters) - MODEL_0826_SUBJECT_PARAMETERS
    if missing or extra:
        raise ValueError(
    ...
    for name in MODEL_0826_SPIKE_PARAMETERS:
...
def _validate_workspace_execution(raw: Any) -> None:
    ...
    if starts != {(3, 0), (3, 1)}:
        raise ValueError("Model 0826 recovery must start from both chi states at M=3.")
...
def _validate_architecture_cells(config: Mapping[str, Any]) -> None:
    ...
    expected = {
        ...
        "PMH": MODEL_0826_SUBJECT_PARAMETERS,
    }
...
def _validate_fixed_parameters(config: Mapping[str, Any]) -> None:
    ...
    if set(fixed) != set(expected):
        raise ValueError("shared_fixed_parameters does not match Model 0826.")
