...
from CategoryLearning_codes.Bayesian_model.evaluation.model_recovery import (  # noqa: E402
    FEATURE_COLUMNS,
...
from CategoryLearning_codes.Bayesian_model.optimization.artifacts import (  # noqa: E402
    subject_best_hyperparams,
    to_builtin,
)
from CategoryLearning_codes.Bayesian_model.optimization.model_0826 import (  # noqa: E402
    extract_model_0826_parameters,
)
from CategoryLearning_codes.Bayesian_model.optimization.parameter_space import (  # noqa: E402
    load_model_parameter_space,
)
from CategoryLearning_codes.Bayesian_model.utils.datasets import resolve_dataset_paths  # noqa: E402
from CategoryLearning_codes.Bayesian_model.utils.seeding import stable_seed  # noqa: E402


DEFAULT_CONFIG = (
    Path(__file__).resolve().parent / "configs/recovery_v1.yaml"
)
PHASES = (
    "smoke",
    "generate",
...
def _design_fingerprint(design: RecoveryDesign) -> str:
    paths = {
        ...
        "recovery_library": (
            ROOT / "CategoryLearning_codes/Bayesian_model/evaluation/model_recovery.py"
        ),
        "model_0826_optimization": (
            ROOT / "CategoryLearning_codes/Bayesian_model/optimization/model_0826.py"
        ),
        "hyper_cd": (
            ROOT
            / "CategoryLearning_codes/Bayesian_model/optimization/search/coordinate_descent.py"
        ),
        "particle_filter": (
            ROOT
            / "CategoryLearning_codes/Bayesian_model/inference/backends/particle_filter.py"
        ),
        "choice_readout": ROOT / "CategoryLearning_codes/Bayesian_model/model/readout.py",
    }
