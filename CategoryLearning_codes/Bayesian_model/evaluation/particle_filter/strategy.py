...
from CategoryLearning_codes.Bayesian_model.metrics import conditional_behavioral_accuracy_band_metrics
...
from CategoryLearning_codes.Bayesian_model.simulation.runner import StateModelSimulationRunner
...
from CategoryLearning_codes.Bayesian_model.utils.subjects import resolve_subject_config
...
def _disable_strategy_controllers(
    ...
    *,
    ...
    transition["class"] = (
        "CategoryLearning_codes.Bayesian_model.model.modules.hypothesis_transition.fixed_strategy."
