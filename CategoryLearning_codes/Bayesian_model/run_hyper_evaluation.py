...
Examples:
    python -m CategoryLearning_codes.Bayesian_model.run_hyper_evaluation \
...
from CategoryLearning_codes.Bayesian_model.optimization.diagnostics.predictive import (
    diagnose_hyper_accuracy_sampling,
    evaluate_volatility_calibration,
)
from CategoryLearning_codes.Bayesian_model.optimization.diagnostics.search import (
...
from CategoryLearning_codes.Bayesian_model.utils.paths import RESULTS_DIR, ROOT_DIR


LOGGER = logging.getLogger(__name__)
DEFAULT_INPUT_DIR = RESULTS_DIR / "model_0826" / "hyper"
DEFAULT_CANDIDATES_JSON = None  # 0826 has no legacy discrete-strategy lookup
