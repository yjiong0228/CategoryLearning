...
from src.Bayesian_state.reference_models.model_0804.pgas import (  # noqa: E402
    run_model0804_pgas,
)
...
def main() -> None:
    ...
    payload = {
        ...
        "implementation_sha256": {
            ...
            "model_0804/pgas.py": _sha256(
                ROOT / "src/Bayesian_state/reference_models/model_0804/pgas.py"
            ),
